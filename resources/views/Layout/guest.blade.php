  ...
  <header>
   <div class="container">
    ...
    <div class="menu">
     ...
     <button aria-labelledby="Trang chủ" type="button" class="btn btn-group-vertical" data-bs-toggle="modal"
      data-bs-target="#signIn">
      <i class='fa-solid fa-user-check' style='font-size:23px'></i>
     </button>
    ...
    <div class="modal-body">
     <form method="post" action="/signUp" enctype="multipart/form-data">
      ...
      <div class="mb-3">
       ...
       <input pattern="[a-zA-Z0-9]{6,15}" type="password" class="form-control" id="pwd1"
      ...
      <div class="mb-3">
       <div class="file-loading">
        ...
        <input type="file" class="form-control" id="avt" placeholder="Enter avt" name="avt"
