...
<head>
  ...
  <link rel="stylesheet" href="../Html/Admin/admin.css">
  ...
  <div class="container">
    <div class="row grid-demo">
      <div id="tt" class="col-md-4">
        <img src="../Html/Sell/img10.png" style="width:100px ;" alt=""><br>
        <div style="text-align: center;">
        <a class="btn btn-outline-light text-dark"  href="/Controller/C_Staff.php">Staff</a>
  <a class="btn btn-outline-light text-dark"  href="/Controller/C_Ticket.php">Ticket</a>
  <a class="btn btn-outline-light text-dark" href="/Controller/C_Result.php">Result</a>
      </div>
</div>
...
<div class="row grid-demo">
<div  class="col-md-2">
<img src="../Html/Admin/img3.png" style="height:480px ;" alt="">
</div>
<div class="col-md-8">
